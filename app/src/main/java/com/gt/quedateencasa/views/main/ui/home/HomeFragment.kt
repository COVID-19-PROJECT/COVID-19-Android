...
class HomeFragment : Fragment() {
    ...
    fun configureStats() {
        ...
        confirmedStat.stat_title.text = "Confirmados"
        confirmedStat.stat_qty.text = "20"
        confirmedStat.stat_qty.setTextColor(Color.RED)
        val confirmedActive = stat_active
        confirmedActive.stat_title.text = "Activos"
        confirmedActive.stat_qty.text = "20"
        confirmedActive.stat_qty.setTextColor(Color.GREEN)
        val confirmedRecovered = stat_recovered
        confirmedRecovered.stat_title.text = "Recuperados"
        confirmedRecovered.stat_qty.text = "20"
        confirmedRecovered.stat_qty.setTextColor(Color.rgb(255, 185, 0))
        val confirmedDead = stat_dead
        confirmedDead.stat_title.text = "Fallecidos"
        confirmedDead.stat_qty.text = "20"
    }
